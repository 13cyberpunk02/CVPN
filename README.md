...
Оба варианта уже включают `sing-box` и среду .NET - ставить что-либо
отдельно не нужно.
...
| Пакет | Зачем |
|---|---|
| [SolimusWrapper](https://www.nuget.org/packages/SolimusWrapper) | запуск ядра и чтение вывода |
...
│   ├── Views/               5 страниц + редактор профиля + экспорт
